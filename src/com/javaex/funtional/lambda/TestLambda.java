...
public class TestLambda {
	/*
	 * 함수형 프로그래밍 : 데이터를 변경시키지 않고(불변), 작업 수행 규칙(함수)를 중심으로 프로그램 작성하는 방식 - 불변성, 함수의 일급
	 * 객체화, 부수 효과 최소화를 목표로 선언적 코드 작성 - 자바인 경우, 람다식 + 스트림을 활용, 함수형 프로그래밍을 작성할 수 있음.
	 * 
...
//		testLambdaParams(10, 20, (x, y) -> x + y);
	...
	private static void testCallLambda() {
		...
		BiFunction<Integer, // 첫번째 입력 파라미터의 타입
